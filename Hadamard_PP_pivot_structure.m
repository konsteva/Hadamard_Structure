...
for i=2:10000 %m=100.000
  ...
  H2_pivots_PP(i,:) = pivot_structure_PP(H);
  [H] = Equivalent_Hadamard(H3);
  H3_pivots_PP(i,:) = pivot_structure_PP(H);
  [H] = Equivalent_Hadamard(H4);
  H4_pivots_PP(i,:) = pivot_structure_PP(H);
